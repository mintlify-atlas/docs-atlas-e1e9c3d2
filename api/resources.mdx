...
Assembles the full Artifact on demand as a zip archive and returns it. Records one install event per unique client (deduplicated by IP and User-Agent within a window). No authentication required.
