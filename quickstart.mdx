---
title: "Get Started with Skillset: Deploy, Publish, and Install"
sidebarTitle: "Quickstart"
description: "Deploy a Skillset Registry with Docker, publish your first Skill from the CLI, and install it into a coding agent — start to finish in five minutes."
---
...
# Object storage — values below target a local MinIO instance; update for S3 in production.
