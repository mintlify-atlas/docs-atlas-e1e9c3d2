---
title: "Authentication and Roles in Skillset"
...
See [Tokens](auth/tokens.mdx) for minting, using, and revoking Tokens.
...
Admins can configure up to three Identity Providers — Google Workspace, Microsoft Entra, and GitHub OAuth — so that Users can sign in without a locally-managed password. They appear as additional buttons on the login page alongside the password form.

See [Identity Providers](auth/identity-providers.mdx) for setup instructions.
